...
The Analytics Go SDK allows you to connect to a xref:analytics:intro:intro.adoc[Enterprise Analytics] cluster from Go.
...
[.column]
.Deployment Docs
* xref:project-docs:enterprise-analytics-sdk-release-notes.adoc[]
