...
[abstract]
{description}
It contains best practices as well as information on TLS/SSL and advanced connection options, and a sub-page on troubleshooting remote connections.
...
[source,golang]
----
include::devguide:example$connecting.go[tags=connecting]
----
...
Our xref:troubleshooting-connections.adoc[Troubleshooting Connections] page will help you to diagnose some problems encountered if your test cluster is in a remote data center, but you are developing on a local laptop -- as well as introducing the SDK doctor tool.
