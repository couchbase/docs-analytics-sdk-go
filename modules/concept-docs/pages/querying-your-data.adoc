...
// 
// It can be seen built at https://docs.couchbase.com/go-analytics-sdk/1.1/concept-docs/querying-your-data.html
...
This enables Zero ETL, reducing costs and complexity, and improving time to insight.
